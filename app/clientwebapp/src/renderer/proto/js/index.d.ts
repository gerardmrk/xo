...
export class RendererParams implements IRendererParams {

    /**
     * Constructs a new RendererParams.
     * @param [properties] Properties to set
     */
    constructor(properties?: IRendererParams);
     ...
     */
    public static create(properties?: IRendererParams): RendererParams;
     ...
     * @returns Writer
     */
    public static encode(message: IRendererParams, writer?: $protobuf.Writer): $protobuf.Writer;
     ...
     * @returns Writer
     */
    public static encodeDelimited(message: IRendererParams, writer?: $protobuf.Writer): $protobuf.Writer;
     ...
     */
    public static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): RendererParams;
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    public static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): RendererParams;
     ...
     * @returns RendererParams
     */
    public static fromObject(object: { [k: string]: any }): RendererParams;
     ...
     */
    public static toObject(message: RendererParams, options?: $protobuf.IConversionOptions): { [k: string]: any };
