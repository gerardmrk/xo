...
$root.internal = (function() {
  ...
  internal.RendererParams = (function() {
    /**
     ...
     * @constructor
     * @param {internal.IRendererParams=} [properties] Properties to set
     */
     ...
     * RendererParams url.
     * @member {string} url
     * @memberof internal.RendererParams
     * @instance
     */
     ...
     * @static
     * @param {internal.IRendererParams=} [properties] Properties to set
     * @returns {internal.RendererParams} RendererParams instance
     */
     ...
     * @memberof internal.RendererParams
     * @static
     * @param {internal.IRendererParams} message RendererParams message or plain object to encode
     ...
     * @returns {internal.RendererParams} RendererParams
    ...
    RendererParams.decode = function decode(reader, length) {
      ...
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.internal.RendererParams();
    ...
    RendererParams.fromObject = function fromObject(object) {
      if (object instanceof $root.internal.RendererParams) return object;
      var message = new $root.internal.RendererParams();
     ...
     * @memberof internal.RendererParams
     * @static
     * @param {internal.RendererParams} message RendererParams
  ...
  internal.RendererResponse = (function() {
    /**
     ...
     * @constructor
     * @param {internal.IRendererResponse=} [properties] Properties to set
     */
     ...
     * @memberof internal.RendererResponse
     * @instance
     */
     ...
     * @static
     * @param {internal.IRendererResponse=} [properties] Properties to set
     * @returns {internal.RendererResponse} RendererResponse instance
     */
     ...
     * @memberof internal.RendererResponse
     * @static
     * @param {internal.IRendererResponse} message RendererResponse message or plain object to encode
     * @param {$protobuf.Writer} [writer] Writer to encode to
     * @returns {$protobuf.Writer} Writer
     */
     ...
     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
     * @param {number} [length] Message length if known beforehand
     * @returns {internal.RendererResponse} RendererResponse
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    RendererResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.internal.RendererResponse();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
    ...
    RendererResponse.verify = function verify(message) {
      ...
      if (message.redirectTo != null && message.hasOwnProperty("redirectTo"))
        if (!$util.isString(message.redirectTo)) return "redirectTo: string expected";
      if (message.renderedHead != null && message.hasOwnProperty("renderedHead"))
        if (
          !(
            (message.renderedHead && typeof message.renderedHead.length === "number") ||
            $util.isString(message.renderedHead)
          )
        )
      ...
      if (message.renderedBody != null && message.hasOwnProperty("renderedBody"))
        if (
          !(
            (message.renderedBody && typeof message.renderedBody.length === "number") ||
            $util.isString(message.renderedBody)
          )
        )
      ...
      if (message.renderedStyles != null && message.hasOwnProperty("renderedStyles"))
        if (
          !(
            (message.renderedStyles && typeof message.renderedStyles.length === "number") ||
            $util.isString(message.renderedStyles)
          )
        )
      ...
      if (message.renderedScripts != null && message.hasOwnProperty("renderedScripts"))
        if (
          !(
            (message.renderedScripts && typeof message.renderedScripts.length === "number") ||
            $util.isString(message.renderedScripts)
          )
        )
          return "renderedScripts: buffer expected";
      if (message.ttr != null && message.hasOwnProperty("ttr"))
        if (!$util.isInteger(message.ttr)) return "ttr: integer expected";
      return null;
    };
    ...
    RendererResponse.fromObject = function fromObject(object) {
      if (object instanceof $root.internal.RendererResponse) return object;
      var message = new $root.internal.RendererResponse();
      if (object.statusCode != null) message.statusCode = object.statusCode | 0;
      if (object.error != null) message.error = String(object.error);
      if (object.redirectTo != null) message.redirectTo = String(object.redirectTo);
      if (object.renderedHead != null)
        if (typeof object.renderedHead === "string")
          $util.base64.decode(
            object.renderedHead,
            (message.renderedHead = $util.newBuffer($util.base64.length(object.renderedHead))),
            0
          );
        else if (object.renderedHead.length) message.renderedHead = object.renderedHead;
      if (object.renderedBody != null)
        if (typeof object.renderedBody === "string")
          $util.base64.decode(
            object.renderedBody,
            (message.renderedBody = $util.newBuffer($util.base64.length(object.renderedBody))),
            0
          );
        else if (object.renderedBody.length) message.renderedBody = object.renderedBody;
      if (object.renderedStyles != null)
        if (typeof object.renderedStyles === "string")
          $util.base64.decode(
            object.renderedStyles,
            (message.renderedStyles = $util.newBuffer($util.base64.length(object.renderedStyles))),
            0
          );
        else if (object.renderedStyles.length) message.renderedStyles = object.renderedStyles;
      if (object.renderedScripts != null)
        if (typeof object.renderedScripts === "string")
          $util.base64.decode(
            object.renderedScripts,
            (message.renderedScripts = $util.newBuffer(
              $util.base64.length(object.renderedScripts)
            )),
            0
          );
        else if (object.renderedScripts.length) message.renderedScripts = object.renderedScripts;
      if (object.ttr != null) message.ttr = object.ttr | 0;
      return message;
    };
     ...
     * @memberof internal.RendererResponse
     * @static
     * @param {internal.RendererResponse} message RendererResponse
     * @param {$protobuf.IConversionOptions} [options] Conversion options
     * @returns {Object.<string,*>} Plain object
     */
    RendererResponse.toObject = function toObject(message, options) {
      ...
      if (options.defaults) {
        ...
        object.error = "";
        object.redirectTo = "";
        if (options.bytes === String) object.renderedHead = "";
        else {
          object.renderedHead = [];
          if (options.bytes !== Array) object.renderedHead = $util.newBuffer(object.renderedHead);
        }
        if (options.bytes === String) object.renderedBody = "";
        else {
          object.renderedBody = [];
          if (options.bytes !== Array) object.renderedBody = $util.newBuffer(object.renderedBody);
        }
        if (options.bytes === String) object.renderedStyles = "";
        else {
          object.renderedStyles = [];
          if (options.bytes !== Array)
            object.renderedStyles = $util.newBuffer(object.renderedStyles);
        }
        if (options.bytes === String) object.renderedScripts = "";
        else {
          object.renderedScripts = [];
          if (options.bytes !== Array)
      ...
      if (message.renderedHead != null && message.hasOwnProperty("renderedHead"))
        object.renderedHead =
          options.bytes === String
            ? $util.base64.encode(message.renderedHead, 0, message.renderedHead.length)
            : options.bytes === Array
              ? Array.prototype.slice.call(message.renderedHead)
              : message.renderedHead;
      if (message.renderedBody != null && message.hasOwnProperty("renderedBody"))
        object.renderedBody =
          options.bytes === String
            ? $util.base64.encode(message.renderedBody, 0, message.renderedBody.length)
            : options.bytes === Array
              ? Array.prototype.slice.call(message.renderedBody)
              : message.renderedBody;
      if (message.renderedStyles != null && message.hasOwnProperty("renderedStyles"))
        object.renderedStyles =
          options.bytes === String
            ? $util.base64.encode(message.renderedStyles, 0, message.renderedStyles.length)
            : options.bytes === Array
              ? Array.prototype.slice.call(message.renderedStyles)
              : message.renderedStyles;
      if (message.renderedScripts != null && message.hasOwnProperty("renderedScripts"))
        object.renderedScripts =
          options.bytes === String
            ? $util.base64.encode(message.renderedScripts, 0, message.renderedScripts.length)
            : options.bytes === Array
              ? Array.prototype.slice.call(message.renderedScripts)
              : message.renderedScripts;
      if (message.ttr != null && message.hasOwnProperty("ttr")) object.ttr = message.ttr;
      return object;
    };
